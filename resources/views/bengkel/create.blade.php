...
@section('title', 'Tambah Data Bengkel')
{{-- @section('css')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Bengkel </h1>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_bengkel" class="form-control" id="nama_bengkel" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="1" name="no_hp" class="form-control" id="no_hp"
                                required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="time" name="jam_buka" class="form-control " id="jam_buka" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="jam_tutup">Jam Tutup :</label>
                            <input type="time" name="jam_tutup" class="form-control" id="jam_tutup" required>
                        </div>
                    </div>
