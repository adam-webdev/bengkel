                    ...
                    <tbody>
                        @foreach ($bengkel as $t)
                            <tr align="center">
                                ...
                                <td>{{ $t->no_hp }}</td>
                                <td>{{ $t->user->name }}</td>
                                <td> <img src="storage/{{ $t->foto_bengkel }}" width="150px" alt="Foto Bengkel"> </td>
                                <td align="center" width="15%">
                                    ...
                                    <a href="{{ route('bengkel.edit', [$t->id]) }}" data-toggle="tooltip" title="Edit"
                                        class="d-none  d-sm-inline-block btn btn-sm btn-success shadow-sm">
                                        <i class="fas fa-edit fa-sm text-white-50"></i>
                                    </a>
                                    <a href="/bengkel/hapus/{{ $t->id }}" data-toggle="tooltip" title="Hapus"
